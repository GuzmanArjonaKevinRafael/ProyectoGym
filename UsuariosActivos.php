...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link active" aria-current="page" href="php/RegistroUsuarios/Registrar.php">Crear Usuario</a>
          <a class="nav-link" href="php/verUsuarios/verUsuarios.php">Ver Usuarios</a>
          <a class="nav-link" href="php/RegistrarPagos/FormularioPagos.php">Pagos</a>
          <a class="nav-link" href="php/RegistrarMaquinas/FormularioMaquinaria.php">Maquinaria </a>
            <a class="nav-link">Bienvenido <?php echo $_SESSION['name']; ?></a>
            <a class="nav-link active" href="php/login/logout.php">Cerrar Sesión</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <main>
    ...
    <div class="container contenedorPrincipal">
      <h1 class="h1Center">Alumnos Activos</h1>
