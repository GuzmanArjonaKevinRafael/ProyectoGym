<?php
	...
	$pdf->Image('../../img/fondito.jpg',160,12,50,35,'jpg');
	...
	$pdf->Cell(150,9,utf8_decode("Disciplina: ". $Disciplina),0,0,'L');
	...
	$pdf->MultiCell(0,9,utf8_decode("Direccion: Calle pedro moreno entre calle galeana y calle nueve,24040 colonia san jose #48"),0,'C',false);
	$pdf->Ln(9);
