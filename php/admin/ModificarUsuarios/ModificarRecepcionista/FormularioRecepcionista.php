...
$sql = "SELECT *  FROM registrosecretaria";
...
<body>
  ...
  <body>
    ...
    <div class="container ">
      ...
      <div class="container">
        <h3 class="h3ce" style="text-align:center;">Modificar Recepcionista</h3>
        <br>
        <div class="table-responsive text-nowrap">
          <table class="table table-hover" id="table">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td class="table-ligth"><?php echo $row['ID_Funcionario'] ?></td>
                  <td class="table-ligth"><?php echo $row['Nombres'] ?></td>
                  <td class="table-ligth"><?php echo $row['ApellidoP'] ?></td>
                  <td class="table-ligth"><?php echo $row['ApellidoM'] ?></td>
                  <td class="table-ligth"><?php echo $row['CorreoElectronico'] ?></td>
                  <td class="table-ligth"><?php echo $row['usuario'] ?></td>
                  <td class="table-ligth"><?php echo $row['Contrasena'] ?></td>
                  <td class="table-ligth"><?php echo $row['Edad'] ?></td>
                  <td class="table-ligth"><?php echo $row['NumTelefono'] ?></td>
                  <td class="table-ligth"><?php echo $row['NumEmer'] ?></td>
                  ...
                  <td class="table-ligth">
                    <a href="actualizar.php?id=<?php echo $row['ID_Funcionario'] ?>" class="btn btn-info">Editar</a>
                    <a href="delete.php?id=<?php echo $row['ID_Funcionario'] ?>" class="btn btn-danger">Eliminar</a>
                  </td>
                </tr>
              <?php
              }
