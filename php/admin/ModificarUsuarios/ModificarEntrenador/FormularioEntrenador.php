...
$sql = "SELECT *  FROM registroentrenador";
...
<body>
  ...
  <body>
    ...
    <div class="container ">
      ...
      <div class="container">
        <h3 class="h3ce" style="text-align:center;">Modificar Entrenador</h3>
        <br>
        <div class="table-responsive text-nowrap">
          <table class="table table-hover" id="table">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td class="table-ligth"><?php echo $row['ID_entrenador'] ?></td>
                  ...
                  <td class="table-ligth"><?php echo $row['usuario'] ?></th>
                  ...
                  <td class="table-ligth">
                    <a href="actualizar.php?id=<?php echo $row['ID_entrenador'] ?>" class="btn btn-warning">Editar</a>
                    <a href="delete.php?id=<?php echo $row['ID_entrenador'] ?>" class="btn btn-danger">Eliminar</a>
                  </td>
