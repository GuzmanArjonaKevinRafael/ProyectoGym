    ...
    <div class="container">
          ...
          <div class="row">
              ...
              <label for="exampleInputEmail1">Disciplina </label>
                    <input type="text" class="form-control mb-3" name="Disciplina" placeholder="Disciplina" value="<?php echo $row['Disciplina']  ?>" pattern="[A-Za-z ]+">
              ...
              <div class="col-6 espacio">
                  ...
                  <input type="text" class="form-control mb-3" name="Nombres" placeholder="Nombre" value="<?php echo $row['Nombres']  ?>" pattern="[A-Za-z0-9 ]+">
                   
              </div>

              <div class="col-6 espacio">
              <label for="exampleInputEmail1">Apellido </label>
                    <input type="text" class="form-control mb-3" name="Apellidos" placeholder="Apellido" value="<?php echo $row['Apellidos']  ?>" pattern="[A-Za-z0-9 ]+">
